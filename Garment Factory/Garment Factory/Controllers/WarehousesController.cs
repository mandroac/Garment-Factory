...
namespace Garment_Factory.Controllers
{
    public class WarehousesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Warehouse_ID,CreateDate,Address,UpdateDate")] Warehouse warehouse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Warehouse_ID,CreateDate,Address,UpdateDate")] Warehouse warehouse)
        {
            if (ModelState.IsValid)
            {
